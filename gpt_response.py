    ...
    response = openai.ChatCompletion.create(
        ...
        messages=[
                {"role": "system", "content": "You are a bot writing multiple choice AP test questions. "
                                              ...
                                              "include a main list called questions, with indexes from 0 to 4. "
                                              "Within each item in it include the string question,"
                                              " a list of the 4 answer choice options as a list named options including strings that include the letter of the"
                                              ...
                                              " of why the correct answer is correct. Make sure that it is valid JSON."},
